...
package body ECS.Entity_Manager is
   ...
   function AddEntity (Manager : in out Entity_Manager_T; Entity_Type : Id_T)
         return Entity_Access is
      Entity : constant Entity_Access := new Entity_T'(
                 Count => Entity_Count,
                 Id => Entity_Type,
                 Destroyed => False,
   ...
   --  Remove destroyed Entities
      for I in reverse Manager.Entities.First_Index ..
         Manager.Entities.Last_Index loop
   ...
   function GetEntity (Manager : in out Entity_Manager_T; Entity_Type : Id_T)
      return Entity_Access is
   begin
