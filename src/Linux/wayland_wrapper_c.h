 ...
 * =========================
 * Sets the callback function to be called on keyboard events.
 * 
 * Parameters:
 *   ctx      - Window context
 *   callback - Function pointer to call on key events (keycode, state)
 */
 ...
 * ==================================
 * Sets the callback function to be called on mouse button events.
 * 
 * Parameters:
 *   ctx      - Window context
 *   callback - Function pointer to call on button events (button, x, y, state)
 */
 ...
 * ==================================
 * Sets the callback function to be called on mouse motion events.
 * 
 * Parameters:
 *   ctx      - Window context
 *   callback - Function pointer to call on motion events (x, y)
 */
 ...
 * wayland_dispatch_pending
 * =========================
 * Processes any pending events without blocking.
 * Unlike wayland_dispatch_event, this returns immediately even
 * if no events are available, making it suitable for game loops.
 * 
 * Parameters:
 *   ctx - Window context from wayland_create_window()
 * 
