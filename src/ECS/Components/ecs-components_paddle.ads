...
package ECS.Components_Paddle is

   -- Paddle component: Player-controlled horizontal platform
   type Paddle is new Component with record
      ...
      -- Input state (TODO: update with input system)
      Move_Left  : Boolean := False;
      Move_Right : Boolean := False;
      
   end record;

end ECS.Components_Paddle;
